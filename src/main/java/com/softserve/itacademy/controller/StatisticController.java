...
public class StatisticController {
    ...
    @GetMapping("/group/avg/{groupId}")
    public ResponseEntity<GroupAvgGradeResponse> getGroupAvgGrade(@PathVariable Integer groupId) {
        return new ResponseEntity<>(statisticService.getGroupAvgGrade(groupId), OK);
    }
}
